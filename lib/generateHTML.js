...
const teamCard = (myTeam) => {
    ...
    for (let i = 0; i < myTeam.length; i++) {
        ...
        console.log(myTeam[i].github + "this is team github")
        ...
        if (myTeam[i].github !== undefined) {
            gitURL += `<a href="https://github.com/${myTeam[i].getGitHub()}" target="_blank">${myTeam[i].getGitHub()}</a>`
        }
            ...
            `<div class="col col-md-12 col-2 card text-center dark-lilac" style="width: 18rem;">
                <div class="card-body ">
                    ...
                    <ul class="list-group text-start">
                        ...
                        <li class="list-group-item">${details}</span>${gitURL}${internSchool}</li >
                    </ul >
